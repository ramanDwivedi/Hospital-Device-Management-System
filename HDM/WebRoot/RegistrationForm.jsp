...
window.location.href="./CheckUserAction?userName="+userName+"&path=./RegistrationForm.jsp";
} 
</script>
		<style type="text/css">
.Title {
				...
				<tr>
					...
					<td width="276">
						<select name="logintype" onChange="cleartext()">
							...
							<option value="Doctor">
								<font size="3" face="Verdana">Doctor</font>
							</option>
							<option value="Financer">
								<font size="3" face="Verdana">Financer</font>
							</option>
						</select>
					</td>
				<tr>
