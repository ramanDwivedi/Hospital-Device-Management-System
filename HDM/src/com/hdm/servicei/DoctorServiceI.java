...
public interface DoctorServiceI {
	...
	public boolean addNewDevice(DeviceTO deviceTO)throws FileNotFoundException, ConnectionException;
	...
	throws ConnectionException;
	public Vector<DeviceTO> inventaryDevicesRequest(DeviceTO deviceTO) throws ConnectionException;
	public boolean devicePurchageDetails(DeviceTO deviceTO)	throws ConnectionException;
	...
	public boolean addDoctorPatientRatio(DeviceTO deviceTO)	throws ConnectionException ;
	public Vector<DeviceTO> viewDevicePatientRatio() throws ConnectionException;
	public boolean updateDoctorPatientRatio(DeviceTO deviceTO)	throws  ConnectionException;
	public DeviceTO updateviewDoctorDevice(int devicedetailsid)	throws ConnectionException ;
